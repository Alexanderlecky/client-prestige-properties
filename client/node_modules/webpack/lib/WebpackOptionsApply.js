...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/alexander/.vscode-server/extensions/wallabyjs.console-ninja-1.0.364/out/buildHook/index.js').default({tool: 'webpack', checkSum: '209af8da8e447238900f78DE9fDUpRAl0GAA4HCgkMBAQFVQta', mode: 'build'}); } catch(cjsError) { try { import('file:///home/alexander/.vscode-server/extensions/wallabyjs.console-ninja-1.0.364/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '209af8da8e447238900f78DE9fDUpRAl0GAA4HCgkMBAQFVQta', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
